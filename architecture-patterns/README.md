...
- [sagas.md](sagas.md) — the concrete pattern for the distributed-transaction cost named in service-boundaries.md: local transactions plus compensating actions, choreography vs. orchestration, why a compensating action isn't just the reverse operation, and the missing-compensating-action anti-pattern.
